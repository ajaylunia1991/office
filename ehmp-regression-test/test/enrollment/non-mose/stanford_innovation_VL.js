...
Data(planDetails.stanford_innovation).Scenario('stanford_innovation_Vivian', async(I, current) =>{
    if( process.env.NODE_ENV == 'prod' ||  process.env.NODE_ENV == 'gpa' ){
        ...
        if (!!~['Anthem','BCBSMI','BCBSGA','BSCA','Stanford'].indexOf(current.carrierName))
        {
