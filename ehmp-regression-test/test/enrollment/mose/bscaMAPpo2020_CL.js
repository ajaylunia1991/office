...
Data(planDetails.bsca_ppo).Scenario('MA_BSCA_PPO_Cassie', async(I, current, mosePage) =>{
    if( process.env.NODE_ENV == 'prod' ||  process.env.NODE_ENV == 'gpa' ){
        ...
        I.wait(1);
        I.see("Optional Supplemental Dental PPO Plan");
        //select rider plan
        I.click(mosePage.fields.riderPlanForBscaPPO);I.wait(1);
