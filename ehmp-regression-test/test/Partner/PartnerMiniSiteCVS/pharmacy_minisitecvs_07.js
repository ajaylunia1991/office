Feature('pharmacy CVS minisite sanity testing--- Created by Aneesha');

var config = require('config');
var domain = config.get('EHMP');
var pharmacy = require(process.cwd() +'/data/pharmacyCVS.js')();

Data(pharmacy.pharmacy_07).Scenario('Aneesha - pharmacy_minisitecvs_07', {retries: 2}, async(I, current, quotePage, minisitePage, leadPage) => {
