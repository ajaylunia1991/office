Feature('ehim vanity URL redirection and logo test - Created by Aneesha');

var config = require('config');
var domain = config.get('EHM');
var startURL = require(process.cwd() +'/data/EHIMAllIdLogo.js')();
//for mdc allid logos
Data(startURL.startURL01).Scenario('test mdc Vanity URL and logo1@verify_ehim_logo1', {retries: 0}, async(I, current) => {
