...
Data(pharmacy.pharmacy_02).Scenario('Aneesha - pharmacy@pharmacy_02 -- Walmart minisite sanity testing', {retries: 2}, async(I, current, quotePage, minisitePage, leadPage) => {
