...
Data(pharmacy.pharmacy_01).Scenario('Aneesha - pharmacy@pharmacy_01 -- Walmart minisite sanity testing', {retries: 2}, async(I, current, quotePage, minisitePage, leadPage) => {
