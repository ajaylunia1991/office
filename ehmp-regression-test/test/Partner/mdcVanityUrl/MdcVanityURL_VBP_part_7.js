Feature('mdc vanity URL redirection and logo test - Created by Aneesha');

var config = require('config');
var domain = config.get('EHM');
var startURL = require(process.cwd() +'/data/MdcVanityLogo.js')();
//for mdc allid logos
Data(startURL.startURL07).Scenario('test mdc Vanity URL and logo1@MdcVanityLogo7', {retries: 0}, async(I, current) => {
