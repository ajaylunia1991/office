...
Data(LandingURL.URL03).Scenario('ENV: ' + process.env.NODE_ENV + ' - Willis - MarketLanding - This scenario verifies verifies market landing pages', async function(I, current, MarketLandingPage) {
    ...
    if (process.env.NODE_ENV == 'cm' | process.env.NODE_ENV == 'qa' ) {
        await I.see('eHealth Medicare is ready to help you with');
    //Verify lead is created
     ...
     I.see('Find the Right Plan for You');
     }
});
