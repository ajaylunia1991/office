...
Scenario('ENV: ' + process.env.NODE_ENV + ' Maria - LeadForm- This scenario verifies Have questions and submit a Lead on MA quote without Prod', async function(I, quotePageEHMP, headerPage, ehmPage) {
...
Scenario('ENV: ' + process.env.NODE_ENV + ' Maria - LeadForm - This scenario verifies Have questions and submit a Lead on MS quote without Prod', async function(I, quotePageEHMP, headerPage, ehmPage) {
...
Scenario('ENV: ' + process.env.NODE_ENV + ' Maria - LeadForm - This scenario verifies Have questions and submit a Lead on MD quote without Prod', async function(I, quotePageEHMP, headerPage, ehmPage) {

    I.amOnPage(domain + '/?type=MD&forceV1=true#quote-plans/MD/12345/33650/SCHENECTADY/1/p1');
    I.wait(5);
