...
Scenario('ENV: ' + process.env.NODE_ENV + ' - Maria - ZipUpdate - This scenario verifies that Filter is cleared after updating zip code on MA quote page and hit Enter', async function(I, quotePageEHMP, headerPage) {
...
Scenario('ENV: ' + process.env.NODE_ENV + ' - Maria - ZipUpdate - This scenario verifies that Filter is cleared after updating zip code on MD quote page and hit Enter', async function(I, quotePageEHMP, headerPage) {
