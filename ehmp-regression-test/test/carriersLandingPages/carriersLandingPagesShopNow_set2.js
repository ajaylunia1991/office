...
var carrier = require(process.cwd() +'/data/carriersLandingPagesURL.js')();
    ...
    Data(carrier.carrier3).Scenario('ENV: ' + process.env.NODE_ENV + ' - Savita - CarrierLanding - Verifies carrier set 3 of URL', async function (I, current,carriersLandingPage) {
        console.log("Verifies carrier set 3 of URL");
            ...
            I.wait(5);
        console.log("Verifying Carrier set 3 and other components");
